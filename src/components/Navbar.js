    ...
    <header className="bg-[#6a0dad] text-white shadow-md">
          ...
          <nav className="flex items-center space-x-6">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 mt-2 bg-white text-gray-800 rounded shadow-lg w-40 hidden group-hover:block z-10">
                <Link to="/graphic-designing" className="block px-4 py-2 hover:bg-gray-100">
                  Graphic Designing
                </Link>
                <Link to="/video-editing" className="block px-4 py-2 hover:bg-gray-100">
                  Video Editing
                </Link>
                <Link to="/digital-marketing" className="block px-4 py-2 hover:bg-gray-100">
                  Digital Marketing
                </Link>
              </div>
            </div>
      ...
      {menuOpen && (
        <div className="md:hidden bg-[#6a0dad] px-4 pb-4 space-y-2 text-sm font-medium">
          <Link to="/about" className="block py-2 border-b border-white/20">About</Link>
          <details className="group">
            <summary className="py-2 cursor-pointer border-b border-white/20">Courses</summary>
            <div className="pl-4 space-y-1 mt-1">
              <Link to="/graphic-designing" className="block">Graphic Designing</Link>
              <Link to="/video-editing" className="block">Video Editing</Link>
              <Link to="/digital-marketing" className="block">Digital Marketing</Link>
            </div>
          </details>
          <Link to="/contact" className="block py-2 border-b border-white/20">Contact</Link>
