...
const Navbar = () => {
  ...
  {/* Logo Text with Gradient Accent */}
  ...
  <p className="text-xs text-white/80 ml-1">Digital Media Pvt. Ltd.</p>
        ...
        <nav className="hidden md:flex items-center space-x-6 text-sm font-medium">
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 mt-2 bg-white text-gray-800 rounded shadow-lg w-40 hidden group-hover:block z-10">
              <a href="#web" className="block px-4 py-2 hover:bg-gray-100">Graphic desgining</a>
        ...
        <div>
          <button
            className="bg-white text-[#6a0dad] font-semibold px-4 py-1 rounded-full hover:bg-gray-100 transition focus:outline-none focus:ring-2 focus:ring-white"
          >
            Sign In
          </button>
        </div>
